...
from tres_coelhos.views import index, tres_coelhos_sorteio, tres_coelhos_excel, tres_coelhos_qrcode

urlpatterns = [
        # path('tres-coelhos', index, name='index'), 
        # Rota para iniciar o sorteio
        path('tres-coelhos/', tres_coelhos_sorteio, name='tres_coelhos_sorteio'), 
