...
class ApartamentoBike(models.Model):
    numero_apartamento = models.CharField(max_length=50)
...
class SorteioBike(models.Model):
    apartamento = models.OneToOneField(ApartamentoBike, on_delete=models.CASCADE)
    vaga = models.OneToOneField(VagaBike, on_delete=models.CASCADE)
