...
class ApartamentoTorre2(models.Model):
    numero_apartamento = models.CharField(max_length=50)
...
class SorteioTorre2(models.Model):
    apartamento = models.OneToOneField(ApartamentoTorre2, on_delete=models.CASCADE)
    vaga = models.OneToOneField(VagaTorre2, on_delete=models.CASCADE)
