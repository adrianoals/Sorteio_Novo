...
from nova_guarulhos.views import ng_aleatorio, ng_excel, ng_zerar, ng_qrcode, ng_inicio, ng_presenca, ng_filtrar, ng_apartamento, ng_pcd, ng_blocos, ng_adimplentes, ng_final
...
urlpatterns = [
        ...
        path('ng-blocos/', ng_blocos, name='ng_blocos'),
